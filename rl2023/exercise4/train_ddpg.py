...
NUM_SEEDS_SWEEP = 15 # NUMBER OF SEEDS TO USE FOR EACH HYPERPARAMETER CONFIGURATION
...
BIPEDAL_CONFIG = {
    "critic_hidden_size": [300, 250], ## Original [64, 64]
    "policy_hidden_size": [300, 250], ## Original [64, 64]
}
BIPEDAL_CONFIG.update(BIPEDAL_CONSTANTS)

### INCLUDE YOUR CHOICE OF HYPERPARAMETERS HERE ###
BIPEDAL_HPARAMS = {
    "critic_hidden_size": [[300, 250]],
    "policy_hidden_size": [[300, 250]],
    }
